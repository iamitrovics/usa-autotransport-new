...
if ( ! function_exists( 'cf_scripts' ) ) {
	...
	function cf_scripts() {
		...
		wp_enqueue_style( 'cf-styles', get_stylesheet_directory_uri() . '/css/theme.min.css', array(), '3.0' );

		wp_enqueue_script( 'jquery' );

		$js_version = $theme_version . '.' . filemtime( get_template_directory() . '/js/theme.min.js' );
		// wp_enqueue_script( 'cf-paralax', get_template_directory_uri() . '/js/parallax.min.js', array(), $js_version, true );
		// wp_enqueue_script( 'cf-fancy', get_template_directory_uri() . '/js/jquery.fancybox.min.js', array(), $js_version, true );
